    ...
    <section className="section">
      <div className="container">
        ...
        <h2 className="subtitle">
          <strong> OpenProtein </strong> is a new machine learning framework for{" "}
          <strong>modeling tertiary protein structure</strong>. Built on top of
          PyTorch, NGL Viewer and ProteinNet, it offers{" "}
          <strong>
      ...
      <Row>
        ...
        <section className="section">
          <div className="container">
            ...
            <p>
              Simply create a pull request in the project's Github repository at{" "}
